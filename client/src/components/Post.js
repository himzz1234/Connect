...
function Post({ post }) {
  ...
  return (
    <div className="bg-bodySecondary px-6 py-4 rounded-md animate__animated animate__zoomIn">
      <div className="flex items-center space-x-4">
        ...
        <div onClick={() => setShowDropdown(!showDropdown)} className="relative cursor-pointer">
          ...
          {(showDropdown && post.userId == currentUser._id) && (
            <div className='text-white absolute w-36 right-0 -bottom-12 bg-bodyPrimary py-2 px-3 rounded-md shadow-2xl border-2 border-bodySecondary'>              
              <div onClick={() => deleteAPost(post?._id)} className="flex items-center justify-between">
      ...
      <div className="flex items-center my-2">
        <div className="flex-1 flex items-center space-x-2">
          ...
          <div onClick={likeAPost} className="active:scale-95 transition-all duration-150 cursor-pointer bg-[#2b80ff] w-6 h-6 rounded-full flex items-center justify-center">
