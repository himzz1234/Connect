...
function ProfilePicture() {
  ...
  return (
    <div className="absolute bottom-0 right-1/2 translate-x-1/2 translate-y-1/2 w-14 h-14 rounded-full border-bodySecondary border-2 cursor-pointer z-20 bg-white">
      <div
        onMouseEnter={() => {
